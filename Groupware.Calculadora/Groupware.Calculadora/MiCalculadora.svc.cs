...
namespace Groupware.Calculadora
{
    ...
    public class MiCalculadora : IMiCalculadora
    {
        ...
        public double OperadorBinario(string operador, double operando, double operandoDos)
        {
            ...
            var laOperacion = new LogicaNegocio.Especificaciones.RealizarOperacionBinaria();
           resultado = laOperacion.RealizarLaOperacionBinaria(miOperador, operando, operandoDos);
